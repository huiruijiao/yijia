$(function(){
	new  Slideshow({
		boxId:"#box",
		imgs:["images/04.jpg","images/7.jpg","images/9.jpg","images/06.jpg"],
		width:1920,
		height:700,
		timeSpace:3000,
		fadeInOutTime:2000,
...
Slideshow.prototype.initUI = function(){
	...
	let ulliStr = "<ul style='position:absolute;right:30px;bottom:0;z-index:999;display:flex;justify-content:space-between'>";
	
	for(let i=0;i<this.imgs.length;i++){
		ulliStr +="<li ord='"+(i+1)+"' style='list-style:none;float:left;margin:10px;padding-top:2px;width:"+this.btnWidth+"px;height:"+this.btnHeight+"px;border-radius:50%;text-align:center;background-color:"+this.btnColor+";'>"+(i+1)+"</li>"
	}
	ulliStr +="</ul>";
